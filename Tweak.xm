...
-(void)applicationDidFinishLaunching:(id)arg1 {
  ...
  JSContext * jsContext = [SEJSContext sharedInstance];
  NSLog(@"abla --- %@", [jsContext evaluateScript:@"XMLHttpRequest.prototype"]);
}
...
-(id)dataTaskWithRequest:(id)arg1 {
  JSContext * jsCtxt = [JSContext new];
  NSLog(@"abla --- %@", [jsCtxt evaluateScript:@"'123'.toString()"]);
